      ...
      <Row>
        <Col sm={12} md={12}>
          <div className={styles.topPic}>
            ...
            <img src='Assets/wwrmobile.png' className={styles.mobile} alt='' />
          </div>
        </Col>
        <Col sm={12} md={12}>
        ...
        <Col sm={12} md={12}>
          <div className={styles.content}>
            <p>
              ...
              fantastic dreaming <span>future virtual architecture</span> needs.
              We support your life on a different dimension.
            </p>
          </div>
        </Col>
      </Row>
